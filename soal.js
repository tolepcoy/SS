    ...
    .onSnapshot((snapshot) => {
     topskorElement.innerHTML = "";
      snapshot.forEach((doc) => {
        ...
        isiDiv.innerHTML = `Lv.${datanya.level} ${datanya.nama} : <span stye="text-align:right">${datanya.poin}</span>`;
